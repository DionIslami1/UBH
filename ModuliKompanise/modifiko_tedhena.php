	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
			...
			<div class="table-wraper">
									...
									<table>
	<tr>
	<h2>Kërko të dhënat per modifikim</h2>
	</tr>
	<tr>
...
($conn,$_REQUEST['term']);     
$sql= mysqli_query ($conn_tdh, "CALL zgjedhTermTedhena('$term')");
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"modifikoTedhena.php?ID_Data=$row[ID_Data]\" class='button' class='button primary'>
		Modifiko</a></td></tr>";		
	}
}
?>           
