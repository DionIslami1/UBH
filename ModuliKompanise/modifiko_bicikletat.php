...
//"SELECT * FROM mosha ORDER BY id_m DESC");
?>
 <!DOCTYPE HTML>
<!--
...
<html>
	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
			...
			<div class="table-wraper">
									...
									<table>
	<tr>
	<h2>Kërko të dhënat e bicikletes për modifikim</h2>
	</tr>
	<tr>
	...
	<td>
	<input type="text" name="term" placeholder="Bicikletat per modifikim"/>
</td>
...
<table width='20%' border=0>
	...
	while($row = mysqli_fetch_array($sql)) { 		
			...
			echo "<td>".$row['name']."</td>";		
			echo "<td><a href=\"modifikoBicikletat.php?id_bicikleta=$row[id_bicikleta]\" class='button' class='button primary'>Modifiko</a> </td>";			
		}
	}
	?>             
</table>
